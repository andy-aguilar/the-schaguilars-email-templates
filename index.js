...
var client = new client_sesv2_1.SESv2Client({ region: "us-east-2" });
var params = {
...
function getBulkEmailEntriesFromRecords(records) {
    return records.map(getBulkEmailEntryFromRecord);
}
function getBulkEmailEntryFromRecord(record) {
    if (!record) {
        return {
            Destination: {
        ...
        var addressLabel = record.addressLabel, id = record.id;
        return {
            Destination: {
                ToAddresses: [record === null || record === void 0 ? void 0 : record.emailAddress]
            },
            ReplacementEmailContent: {
                ReplacementTemplate: {
                    ReplacementTemplateData: JSON.stringify({ addressLabel: addressLabel, id: id })
                }
            }
        };
    }
